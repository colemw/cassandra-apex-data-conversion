...
public class NonStudentItems implements DataObject {
    ...
    public NonStudentItems(Row row) {
    ...
    public NonStudentItems(String cid, String ctype, int so, UUID id, String dsc, String cnttype, String cntid, String cnthref,
