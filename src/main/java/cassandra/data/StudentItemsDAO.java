...
public class StudentItemsDAO implements DataObject {
    ...
    public StudentItemsDAO(Row row) {
    ...
    public StudentItemsDAO(String cid, String ctype, int so, UUID id, String dsc, String cnttype, String cntid, String cnthref,
